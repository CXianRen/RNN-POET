...
class LHeiNet():
    def __init__(self):
        ...
        self.decoder = LuongAttnDecoderRNN(attn_model, self.embedding, hidden_size, embedding_size, decoder_n_layers, dropout)
    ...
    def loadmodel(self,model_path):
        ...
        import pickle
        self.voc= pickle.loads(checkpoint['voc_dict'])

    def train_setting(self,voc):
        self.voc=voc
    ...
    def run(self):
        ...
        self.evaluateInput(self.encoder, self.decoder,searcher, self.voc)    


if __name__ == "__main__":
    lnet=LHeiNet()
    lnet.loadmodel('./save/lhei_model/poet_jg_5jueju.txt/2-2_500/9000_checkpoint.tar')
    lnet.run()